...
async function seedBekalPool() {
  ...
  try {
    ...
    const proteinRecipes = [
      ...
      {
        name: 'Sosis Bumbu Merah',
        description: 'Sosis sapi yang dimasak dengan bumbu dasar merah yang pedas dan gurih, super praktis dan cepat.',
        bumbu: 'merah', estimasi_waktu: 15, kalori: 250,
        tips_bekal: 'Sangat cepat dibuat di pagi hari. Gunakan sosis berkualitas tinggi.',
        ingredients: [
          { name: 'Sosis sapi (potong serong)', qty: 3, unit: 'buah' },
          { name: 'Bumbu Dasar Merah', qty: 2, unit: 'sdm', is_bumbu: true },
          { name: 'Bawang bombay (iris)', qty: 20, unit: 'gram' },
          { name: 'Kecap manis', qty: 1, unit: 'sdm' },
          { name: 'Garam', qty: 0.25, unit: 'sdt' },
          { name: 'Minyak goreng', qty: 1, unit: 'sdm' },
        ],
        steps: [
          'Panaskan minyak, tumis bumbu dasar merah dan bawang bombay sampai harum.',
          'Masukkan sosis yang sudah dipotong, aduk rata.',
          'Tambahkan kecap manis dan garam. Masak selama 3-5 menit sampai bumbu meresap.',
          'Angkat dan sajikan untuk bekal.',
        ],
      },
      {
      ...
      {
        name: 'Ayam Popcorn Bumbu Putih',
        description: 'Ayam fillet potong dadu kecil yang dimarinasi bumbu putih lalu digoreng tepung renyah.',
        bumbu: 'putih', estimasi_waktu: 20, kalori: 300,
        tips_bekal: 'Goreng dengan api sedang agar matang merata. Tepung krispi tahan lama.',
        ingredients: [
          { name: 'Dada ayam fillet', qty: 150, unit: 'gram' },
          { name: 'Bumbu Dasar Putih', qty: 1, unit: 'sdm', is_bumbu: true },
          { name: 'Tepung bumbu serbaguna', qty: 3, unit: 'sdm' },
          { name: 'Minyak goreng', qty: 200, unit: 'ml' },
        ],
        steps: [
          'Potong ayam dadu kecil-kecil. Marinasi dengan bumbu dasar putih selama 10 menit.',
          'Gulingkan potongan ayam ke dalam tepung bumbu kering sampai terbalut rata.',
          'Goreng dalam minyak panas sampai kuning keemasan dan renyah.',
          'Angkat dan tiriskan. Dinginkan sebelum masuk kotak bekal.',
        ],
      },
    ...
    const sayuranRecipes = [
      ...
      {
        name: 'Sayur Tahu Kuning',
        description: 'Tahu putih yang dimasak dalam kuah kuning gurih tanpa santan.',
        bumbu: 'kuning', estimasi_waktu: 15, kalori: 120,
        tips_bekal: 'Tahu menyerap bumbu dengan sangat baik. Praktis dan tidak mudah basi.',
        ingredients: [
          { name: 'Tahu putih (potong dadu)', qty: 150, unit: 'gram' },
          { name: 'Bumbu Dasar Kuning', qty: 1, unit: 'sdm', is_bumbu: true },
          { name: 'Air', qty: 100, unit: 'ml' },
          { name: 'Garam dan Kaldu jamur', qty: 0.5, unit: 'sdt' },
          { name: 'Minyak goreng', qty: 1, unit: 'sdm' },
        ],
        steps: [
          'Tumis bumbu dasar kuning sampai harum.',
          'Masukkan air, masak hingga mendidih.',
          'Tambahkan tahu putih, garam, dan kaldu jamur.',
          'Masak dengan api sedang selama 5-7 menit sampai kuah agak menyusut dan meresap.',
          'Angkat dan kemas.',
        ],
      },
      {
