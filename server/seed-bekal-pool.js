...
async function seedBekalPool() {
  ...
  try {
    ...
    const proteinRecipes = [
      ...
      {
        name: 'Telur Ceplok Bumbu Merah',
        description: 'Telur mata sapi yang dimasak dengan bumbu dasar merah pedas manis, super praktis dan sangat murah.',
        bumbu: 'merah', estimasi_waktu: 15, kalori: 210,
        tips_bekal: 'Sangat cepat dibuat di pagi hari. Goreng telur ceplok matang agar tidak hancur saat dibawa.',
        ingredients: [
          { name: 'Telur ayam', qty: 2, unit: 'butir' },
          { name: 'Bumbu Dasar Merah', qty: 1.5, unit: 'sdm', is_bumbu: true },
          { name: 'Kecap manis', qty: 1, unit: 'sdm' },
        ...
        steps: [
          'Panaskan minyak, goreng telur menjadi telur mata sapi (ceplok). Sisihkan.',
          'Tumis bumbu dasar merah dengan sisa minyak sampai harum.',
          'Tambahkan kecap manis, garam, dan sedikit air.',
          'Masukkan telur ceplok, masak selama 2-3 menit sampai bumbu meresap.',
