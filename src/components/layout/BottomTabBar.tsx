...
export function BottomTabBar() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-[100] lg:hidden bg-background/80 backdrop-blur-xl backdrop-saturate-150 border-t border-white/20 dark:border-white/10 shadow-[0_-1px_3px_rgba(0,0,0,0.02)]">
          ...
          return (
            ...
            >
              ...
              >
                ...
                <span className={cn(
                  "text-[10px] tracking-wide leading-tight mt-0.5 transition-all duration-200",
